...
- **Persistent SQLite storage** : Tasks saved in `tasks.db` file (auto-created)
...
Built with Go, Gorilla Mux, and SQLite. Inspired by the need for simple, reliable, and beautiful APIs.
